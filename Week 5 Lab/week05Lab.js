 ...
 *
 * ↓ YOUR CODE HERE ↓ */
console.log(`On July 20th ${person.year}, ${person.firstname} ${person.lastname} was the first person to set foot on Earth's moon.`)
 ...
 *
 * ↓ YOUR CODE HERE ↓ */
let myGreeting =new Greeting('Uriel', 'CA')
myGreeting.hello()
/*-------------------------------------------------------*/
 ...
 *
 * ↓ YOUR CODE HERE ↓ */
let myBook = new Book("Pride and Predudice", "Jane Austen")
console.log(myBook.title)
console.log(myBook.author)

console.log(myBook.describe())

let yourBook = new Book("One Fish Two Fish", "Dr. Suess")
...
// Look at the provided code below. Notice how Student and Teacher inherit from the
// Person class through the use of the "extends" and "super" key words. Also, how 
// Student has a redefined details method that is more appropriate than the details 
// method it would have inherited from the Person super class...
...
let movie1 = new Movie("Jurrasic Park", "Steven Speilberg");
let movie2 = new Movie("Grinch", "Ron Howard");
